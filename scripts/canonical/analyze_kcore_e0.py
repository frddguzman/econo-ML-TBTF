"""§3.1.4 — K-core decomposition at η=0 (no-bailout-inflation baseline; Loop 2 inactive).

Mirrors analyze_kcore_e085.py at η=0.
Reads ../Simulations/topology_w58_{nt,st,t5_rf}_e0.json.
"""
import os, sys, json
...
setup_mpl()
OUT = asset_path('ch3_1_topology', '3_1_4_kcore_e0.png')
...
def main():
    ...
    fig.suptitle(r'K-core decomposition at $t=999$, canonical w58 cv=0, $\eta=0$ '
                 r'(no-bailout-inflation baseline; Loop 2 inactive)',
                 fontsize=10, y=0.99)
