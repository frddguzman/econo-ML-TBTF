"""§3.1.4 — K-core decomposition at η=0.85 (above selectivity flip η†=5/6).

Mirrors analyze_kcore.py at η=0.85.
Reads ../Simulations/topology_w58_{nt,st,t5_rf}_e085.json.
"""
import os, sys, json
...
setup_mpl()
OUT = asset_path('ch3_1_topology', '3_1_4_kcore_e085.png')
...
def main():
    ...
    fig.suptitle(r'K-core decomposition at $t=999$, canonical w58 cv=0, $\eta=0.85$ '
                 r'(above selectivity flip $\eta^\dagger=5/6$)',
                 fontsize=10, y=0.99)
