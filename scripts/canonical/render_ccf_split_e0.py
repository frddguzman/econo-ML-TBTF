"""§3.1 — CCF split figures at η=0 (no-bailout-inflation baseline; Loop 2 inactive).

Mirrors render_ccf_split.py at η=0. Reads dashboard.html const DATA cells
`w58_t5_{nt,st,rf}_e0`. Outputs CCF chain + fiscal figures with η=0 caption.

Output: thesis_assets/ch3_3_claim2_contagion/3_3_2_ccf_{chain,fiscal}_e0.png
"""
import os, sys, json
