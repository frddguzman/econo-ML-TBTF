"""Quick dump of canonical w58 topology JSONs for no-tax and ex-ante τ=1e-5 regimes.

Existing dumps are ex-post regime only. This fills the missing 2 regimes so
§3.1.2 topology snapshots can render all 3.

Output: ../Simulations/topology_w58_nt_e01.json + topology_w58_t5_rf_e01.json
Total: 2 sims at SEED=26474, η=0.10, ~30 sec.
"""
...
def dump_one(label, regime, fund_levy_rate=None):
    out_path = f'../Simulations/topology_w58_{label}_e01.json'
...
def main():
    print('Dumping missing topology JSONs at SEED=26474, eta=0.10:')
    dump_one('nt', 'none')
