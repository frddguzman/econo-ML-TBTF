"""Dump 9 dashboard cells each for c3_g12 (gamma=0.12) and c3_g05 (gamma=0.05).
3 regimes × 3 etas = 9 cells per cand × 2 cands = 18 cells total.
Run AFTER sweep_c3_gamma_thesis.py finishes.
"""
import os
...
def main():
    ...
    print(f'C3-gamma cells: {len(jobs)} sims, {workers} workers')
