"""Dump canonical w58 topology JSONs at η=0.85 (above selectivity flip η†=5/6).

Mirrors dump_topology_multi_regime.py but at η=0.85 for the §3.1.3 / §3.1.4
extension to the high-η regime. SEED=26474, 3 regimes (nt, ex-post, ex-ante τ=1e-5).

Output: ../Simulations/topology_w58_{nt,st,t5_rf}_e085.json
Total: 3 sims at SEED=26474, η=0.85, ~45 sec.
"""
...
def dump_one(label, regime, fund_levy_rate=None):
    out_path = f'../Simulations/topology_w58_{label}_e085.json'
